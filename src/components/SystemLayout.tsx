...
import {
  ...
  Shield, Building2, Sun, Moon, Phone, Clock, GitBranch, Truck, MessageSquareQuote, FileSpreadsheet, Code2
} from "lucide-react";
...
const mainNavItems: NavItem[] = [
  ...
  { id: "pos", path: "/pos/screen", label: "نقطة البيع", icon: Monitor },
  {
    ...
    children: [
      ...
      { id: "sales-channels", path: "/pos/channels", label: "قنوات البيع وأسعارها", icon: Tags },
      ...
      { id: "sales-pos-api", path: "/integrations/pos-api", label: "التكامل مع نقاط البيع", icon: Code2 },
    ],
  },
  {
