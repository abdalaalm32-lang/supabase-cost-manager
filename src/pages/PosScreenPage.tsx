    ...
    onSuccess: (sale, status) => {
      ...
      if (status === "مكتمل") {
        setReceiptData({
          ...
          deliveryCompanyName: orderType === "دليفري" ? editingDeliveryCompanyName : undefined,
        });
